...
if( !class_exists( 'Pixova_Lite_Theme_Support' ) ) {
    class Pixova_Lite_Theme_Support extends WP_Customize_Control
    {
        ...
        { ?>
            ...
            <div class="pro-box">
                <a href="<?php echo esc_url( __('https://www.machothemes.com/?edd_action=add_to_cart&download_id=13&discount=DEMO20', 'pixova-lite'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'Upgrade and get 20% off','pixova-lite' ); ?></a>
            </div>
...
if( !class_exists( 'Pixova_Lite_Theme_Support_Googlemap' ) ) {
    class Pixova_Lite_Theme_Support_Googlemap extends WP_Customize_Control
    {
        ...
        { ?>
            ...
            <div class="pro-box">
                <a href="<?php echo esc_url( __('https://www.machothemes.com/?edd_action=add_to_cart&download_id=13&discount=DEMO20', 'pixova-lite'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'Buy Now and get 20% off','pixova-lite' ); ?></a>
            </div>
